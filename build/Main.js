...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function () {
	    ...
	    Main.prototype.init = function init() {
	        var chart = new _BarChart2["default"]();
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarChart = function BarChart() {
	    ...
	    d3.select("#myGraph").selectAll("rect").data(dataSet).enter().append("rect").on("click", function () {
	        d3.select(this).style("fill", "cyan");
	    }).attr("x", 0).attr("y", function (d, i) {
	        return i * 25;
	    }).attr("width", 0).transition().delay(function (d, i) {
	        return i * 100;
	    })
	    //.duration(2500)
	    .attr("height", "20px").attr("width", function (d, i) {
	        return d + "px";
	    });
	    ...
	    d3.select('#updateButton').on('click', function () {
	        ...
	        d3.select("#myGraph").selectAll("rect").data(dataSet).transition().delay(function (d, i) {
	            return i * 100;
